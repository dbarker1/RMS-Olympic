...
if abs(RS_uv_min) >= abs(RS_uv_max):
	RS_uv_lim = abs(RS_uv_min)
else:
	RS_uv_lim = abs(RS_uv_max)

if abs(RS_uw_min) >= abs(RS_uw_max):
	RS_uw_lim = abs(RS_uw_min)
else:
	RS_uw_lim = abs(RS_uw_max)

if abs(RS_vw_min) >= abs(RS_vw_max):
	RS_vw_lim = abs(RS_vw_min)
else:
	RS_vw_lim = abs(RS_vw_max)
...
plt.xlim(0,ana_t[-1])
plt.ylim(-1 * RS_uv_lim * 1.1, RS_uv_lim * 1.1)
...
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(-1 * RS_uw_lim * 1.1, RS_uw_lim * 1.1)
...
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(-1 * RS_vw_lim * 1.1, RS_vw_lim * 1.1)
