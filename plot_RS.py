...
plt.plot(ana_t, RS_uv_t)
plt.ylabel(r"$\left\langle\bar{uv}\right\rangle$")
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(np.min(RS_uv_t) * 1.1, np.max(RS_uv_t) * 1.1)
plt.savefig(save_direc + "RS_uv_t")
plt.close()
plt.clf()

plt.plot(ana_t, RS_uw_t)
plt.ylabel(r"$\left\langle\bar{uw}\right\rangle$")
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(np.min(RS_uw_t) * 1.1, np.max(RS_uw_t) * 1.1)
plt.savefig(save_direc + "RS_uw_t")
plt.close()
plt.clf()

plt.plot(ana_t, RS_vw_t)
plt.ylabel(r"$\left\langle\bar{vw}\right\rangle$")
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(np.min(RS_vw_t) * 1.1, np.max(RS_vw_t) * 1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(np.min(RS_uv_z) * 1.1, np.max(RS_uv_z) * 1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(np.min(RS_uw_z) * 1.1, np.max(RS_uw_z) * 1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(np.min(RS_vw_z) * 1.1, np.max(RS_vw_z) * 1.1)
