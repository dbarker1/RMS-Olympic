...
plt.xlim(0,ana_t[-1])
plt.ylim(-1 * np.max(RS_uv_t) * 1.1, np.max(RS_uv_t) * 1.1)
...
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(-1 * np.max(RS_uw_t) * 1.1, np.max(RS_uw_t) * 1.1)
...
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(-1 * np.max(RS_vw_t) * 1.1, np.max(RS_vw_t) * 1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(-1 * np.max(RS_uv_z) * 1.1, np.max(RS_uv_z) * 1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(-1 * np.max(RS_uw_z) * 1.1, np.max(RS_uw_z) * 1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(-1 * np.max(RS_vw_z) * 1.1, np.max(RS_vw_z) * 1.1)
