...
plt.xlim(0,ana_t[-1])
plt.ylim(-np.max(RS_z_t)*1.1, np.max(RS_z_t)*1.1)
...
plt.xlabel(r"Time / $\tau_\nu$")
plt.xlim(0,ana_t[-1])
plt.ylim(-np.max(RS_y_t)*1.1, np.max(RS_y_t)*1.1)
...
plt.xlabel(r"z")
plt.xlim(0,z[-1])
plt.ylim(-np.max(RS_z_z)*1.1, np.max(RS_z_z)*1.1)
...
plt.xlabel(r"y")
plt.xlim(0,y[-1])
plt.ylim(-np.max(RS_y_y)*1.1, np.max(RS_y_y)*1.1)
